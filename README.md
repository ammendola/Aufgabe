...
Der drittletzte Schritt des beschriebenen Datenfluss-Workflows bietet aus Sicht des Autors eine Möglichkeit, den Prozess dahingehend zu optimieren, dass man den bislang manuell durchgeführten Vorgang, die ZIP-Dateien in das Upload-Verzeichnis hochzuladen, automatisiert. Hierfür könnte man ein Skript schreiben, das genau diesen Vorgang initiiert, sobald ZIP-Dateien auf dem lokalen Server generiert worden sind (ggf. mit einem einleitenden Watch-Skript). Das ursprünglich angenommenen Speicherproblem auf dem Upload-Server hat sich als unproblematisch herausgestellt. Allerdings darf die Datenmenge pro Upload-Vorgang nicht größer als 300 GB sein, damit der Upload in einem nächtlichen Prozess durchlaufen kann. Die täglichen Arbeitsprozesse in der VL dürfen durch einen fortdauernden Upload am nächsten Morgen auf keinen Fall behindert werden.
...
[2]: https://www.danrw.de/ueber-das-da-nrw/die-nrw-loesung/ (zuletzt abgerufen am 20.05.2019).<br/>
